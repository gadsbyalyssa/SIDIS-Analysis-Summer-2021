...
void DifferenceMethodSpringBin4()
{
...
c01->Divide(2,2);
c01->Print("DifferenceMethodBin4.pdf[");
TH1F*h1 = new TH1F("h1","h1",100, 0, 4);
c01->cd(1);
h1->GetXaxis()->SetTitle("[0.3<pTpT<0.4]");
...
outTree->Draw("Delta_phi>>h1", PosHeli && pTkT4 && Mxg1 && zp);
TH1F*h2 = new TH1F("h2","h2",100, 0, 7);
c01->cd(2);
h2->GetXaxis()->SetTitle("[0.3<pTpT<0.4]");
...
outTree->Draw("Delta_phi>>h2", PosHeli && pTkT4 && Mxg1 && p2);
TH1F*h3 = new TH1F("h3","h3",100, 0, 4);
c01->cd(3);
h3->GetXaxis()->SetTitle("[0.3<pTpT<0.4]");
...
outTree->Draw("Delta_phi>>h3", NegHeli && pTkT4 && Mxg1 && zp);
TH1F*h4 = new TH1F("h4","h4",100, 0, 7);
c01->cd(4);
h4->GetXaxis()->SetTitle("[0.3<pTpT<0.4]");
...
outTree->Draw("Delta_phi>>h4", NegHeli && pTkT4 && Mxg1 && p2);
