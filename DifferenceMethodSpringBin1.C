...
void DifferenceMethodSpringBin1()
{
...
c01->Divide(2,2);
c01->Print("DifferenceMethodBin1.pdf[");
...
outTree->Draw("Delta_phi>>h1", PosHeli && pTkT1 && Mxg1 && zp);
...
outTree->Draw("Delta_phi>>h2", PosHeli && pTkT1 && Mxg1 && p2);
TH1F*h3 = new TH1F("h3","h3",100, 0, 4);
c01->cd(3);
h3->GetXaxis()->SetTitle("[0<pTpT<0.1]");
...
outTree->Draw("Delta_phi>>h3", NegHeli && pTkT1 && Mxg1 && zp);
TH1F*h4 = new TH1F("h4","h4",100, 0, 7);
c01->cd(4);
h4->GetXaxis()->SetTitle("[0<pTpT<0.1]");
...
outTree->Draw("Delta_phi>>h4", NegHeli && pTkT1 && Mxg1 && p2);
