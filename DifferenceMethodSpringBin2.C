...
void DifferenceMethodSpringBin2()
{
...
c01->Divide(2,2);
c01->Print("DifferenceMethodBin2.pdf[");
TH1F*h1 = new TH1F("h1","h1",100, 0, 4);
c01->cd(1);
h1->GetXaxis()->SetTitle("[0.1<pTpT<0.2]");
...
outTree->Draw("Delta_phi>>h1", PosHeli && pTkT2 && Mxg1 && zp);
TH1F*h2 = new TH1F("h2","h2",100, 0, 7);
c01->cd(2);
h2->GetXaxis()->SetTitle("[0.1<pTpT<0.2]");
...
outTree->Draw("Delta_phi>>h2", PosHeli && pTkT2 && Mxg1 && p2);
...
outTree->Draw("Delta_phi>>h3", NegHeli && pTkT2 && Mxg1 && zp);
...
outTree->Draw("Delta_phi>>h4", NegHeli && pTkT2 && Mxg1 && p2);
