...
public class AsymMMSpring
{
  public static void main(String args[])
  {
    Scanner inputStream = null;
    
    double[][] xa = new double [14][1000];
    double[][] xb = new double [14][1000];
    double[][] ya = new double [14][1000];
    double[][] yb = new double [14][1000];
    double[][] sin = new double [14][1000];
    double[][] x2 = new double [14][1000];
    double[][] y2 = new double [14][1000];
 ...
 try //Table 7
    {
      inputStream =
        new Scanner(new FileInputStream("MomentsMethodBin7.txt"));
    }
    catch(FileNotFoundException e)
    {
      System.exit(0);
    ...
    while(inputStream.hasNextDouble())
    {
      xa[6][q] = inputStream.nextDouble();
      ya[6][q] = inputStream.nextDouble();
      xb[6][q] = inputStream.nextDouble();
      yb[6][q] = inputStream.nextDouble();
      x2[6][q] = inputStream.nextDouble();
      y2[6][q] = inputStream.nextDouble();
      
      sum[6]=sum[6]+(xa[6][q]*ya[6][q]); //Sum(xa*ya)
      sum1[6]=sum1[6]+(yb[6][q]*xb[6][q]); //Sum(xb*yb)
      sum2[6]=sum2[6]+(x2[6][q]*y2[6][q]);
      
      sumYa[6]=sumYa[6]+ya[6][q];
      sumYb[6]=sumYb[6]+yb[6][q];
      sumY2[6]=sumY2[6]+y2[6][q];
   ...
   while (n < 7)
    {
      ...
      erA[n]= (1/(2*p))*Math.sqrt((sumYa[n]*sumYb[n])/Math.pow(sumY2[n],3));
